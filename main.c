...
/*
Вопросы:
1. Почему на языке Си у вас 2 функции, а на ассемблере одна ?  
Надо сделать точно также как на языке Си. 
Функция, которая ищет номер нуля или его адрес и функция, которая запишет всё в новый массив. 
2. Выровнять табуляцию и пробелы в коде! Должно быть аккуратно.
...
int32_t array_upor (int32_t* new_array, size_t array_size,int32_t* zero_index)
{
	...
	int32_t* a=0;                // вспомогательная переменная		// ПОЧЕМУ УКАЗАТЕЛЬ НА ПЕРЕМЕННУЮ а ?????
	while (a < (zero_index))  
	{
